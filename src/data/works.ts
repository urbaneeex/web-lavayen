...
export type WorkProject = {
	...
	desc?: string;
	/** Imagen principal del listado */
	img: string;
	alt: string;
	/** Galería en la ficha (mínimo una; suele coincidir con la portada) */
...
export const workProjects: WorkProject[] = [
	{
		...
		gallery: [
			{
				src: '/images/symphony.webp',
				alt: 'Collage La Sinfonía del Caos — contraste azul eléctrico y capas urbanas'
			},
			{
				src: '/images/symphony.webp',
				alt: 'Collage La Sinfonía del Caos — animales y señales pop en alto contraste'
			},
			{
				src: '/images/symphony.webp',
				alt: 'Collage La Sinfonía del Caos — composición simétrica rota y ritmo visual'
			},
			{
				src: '/images/symphony.webp',
				alt: 'Collage La Sinfonía del Caos — energía urbana y destellos'
			},
			{
				src: '/images/symphony.webp',
				alt: 'Collage La Sinfonía del Caos — serie sobre ruido y caos cotidiano'
			}
		],
		detailHtml: `
	...
	},
	{
		...
		gallery: [{ src: '/images/womo.webp', alt: 'WOMO Brand — branding' }],
		detailHtml: `
	...
	},
	{
		...
		gallery: [{ src: '/images/goodfellas.avif', alt: "Campaña de pizzas Goodfella's" }],
		detailHtml: `
	...
	},
	{
		...
		gallery: [{ src: '/images/amor-fatum.webp', alt: 'Amor Fatum — perfume' }],
		detailHtml: `
	...
	},
	{
		...
		gallery: [{ src: '/images/packaging.webp', alt: 'Packaging — ediciones promocionales de libros' }],
		detailHtml: `
	...
	},
	{
		...
		gallery: [{ src: '/images/carteleria.webp', alt: 'Cartelería — piezas de gran formato y mensaje directo' }],
		detailHtml:
	...
	},
	{
		...
		img: '/images/womo.webp',
		alt: 'Merchandising para el Museo del Traje — producto y gráfica',
		gallery: [{ src: '/images/womo.webp', alt: 'Merchandising Museo del Traje — colección inspirada en piezas del museo' }],
		detailHtml:
	...
	},
	{
		...
		gallery: [{ src: '/images/beauty.webp', alt: 'Beauty Pom Pom — sistema visual' }],
		detailHtml: `
	...
	},
	{
		...
		gallery: [{ src: '/images/symphony.webp', alt: 'Motion graphics y montaje de vídeo — still de proyecto audiovisual' }],
		detailHtml:
	...
	},
	{
		...
		gallery: [{ src: '/images/campanas-digitales.webp', alt: 'Campañas digitales — banners HTML5' }],
		detailHtml:
	...
	},
	{
		...
		gallery: [{ src: '/images/diseno-editorial.webp', alt: 'Diseño editorial' }],
		detailHtml: `
	...
	},
	{
		...
		gallery: [{ src: '/images/lesj.webp', alt: 'LESJ Centro estético — branding' }],
		detailHtml: `
	...
	},
	{
		...
		gallery: [{ src: '/images/shimano.webp', alt: 'Shimano Days — evento Shimano' }],
		detailHtml: `
	...
	},
	{
		...
		gallery: [{ src: '/images/diseno-ambiental.webp', alt: 'Diseño ambiental — oficinas AMADEUS' }],
		detailHtml: `
